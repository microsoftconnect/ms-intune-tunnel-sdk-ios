...
Version [2.0.0](https://github.com/microsoftconnect/ms-intune-tunnel-sdk-ios/releases/tag/2.0.0)
...
| ----------------------- | ----------------------- | ---------------------------- | -----------------------------  | ----------------- |                         
| 21.2.0+                     | 2.2.0+              | 16.0+                               | 26.0+                                       | Main release branch - supports all feature work and bug fixes |
